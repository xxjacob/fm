package com.ideax.fm360.script;
...
import com.ideax.fm360.pojo.NovelAudioChapters;
import com.ideax.fm360.pojo.NovelAudioKting;
...
public class KtingSpider {
	...
	String novelFile = "D://novel.txt";
	String chapterFile = "D://chapter.txt";

	public static void main(String args[]) throws IOException {
		new KtingSpider().start();
	}
